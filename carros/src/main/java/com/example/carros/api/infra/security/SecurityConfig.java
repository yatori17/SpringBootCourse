...
@Configuration
@EnableWebSecurity
@EnableGlobalMethodSecurity(securedEnabled = true) //Habilitar segurança por método
public class SecurityConfig extends WebSecurityConfigurerAdapter {
 ...
 /*   @Override
    protected  void configure(HttpSecurity http) throws Exception{
        //deixando apenas o basic authentication como modelo
        http
                .authorizeRequests()
                .anyRequest().authenticated()
                .and()
                .httpBasic()
                .and().csrf().disable(); //Desabilitar crsf (OK para apis)
    }*/
